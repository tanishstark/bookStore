...
<div class="container py-5">
  <div class="row g-4 align-items-start">
    ...
    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
      echo "<div class='d-flex flex-column flex-sm-row gap-3 mb-4'>
      <a class='btn btn-success btn-lg w-100 w-sm-auto' href='cart.php?book_id=" . $book_id . "'>Add to Cart</a>
      <a class='btn btn-outline-success btn-lg w-100 w-sm-auto' href='#'>Buy Now</a>
    </div>";
    } else {
      $showAlert1 = "First login to add to item to cart";
      $showAlert2 = "First login to buy item";
      echo "<div class='d-flex flex-column flex-sm-row gap-3 mb-4'>
      <a class='btn btn-success btn-lg w-100 w-sm-auto' href='partials/_login.php?visit=" . $showAlert1 . "'>Add to Cart</a>
      <a class='btn btn-outline-success btn-lg w-100 w-sm-auto' href='partials/_login.php?visit=" . $showAlert2 . "'>Buy Now</a>
    </div>";
    }
    ?>
