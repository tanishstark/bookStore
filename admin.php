...
<body>
    ...
    if($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['deleteId'])){
      ...
      $query = "DELETE FROM `booklist` WHERE `booklist`.`book_id` = $book_id";
        ...
        <div class="modal-body">
          <form action="" method="POST">
              ...
              <div class="row g-3">
                ...
                <textarea id="imageEdit" name="imageEdit" class="form-control" placeholder="Upload image" rows="4"></textarea>
              </div>
              <div class="col-md-4">
                <label for="titleEdit" class="form-label">Book Title</label>
                <textarea id="titleEdit" name="titleEdit" class="form-control" placeholder="Enter title" rows="4"></textarea>
              </div>
              <div class="col-md-4">
                <label for="publisherEdit" class="form-label">Publisher</label>
                <input type="text" id="publisherEdit" name="publisherEdit" class="form-control" placeholder="Enter publisher" />
              </div>
              <div class="col-md-4">
                <label for="retail_priceEdit" class="form-label">Retail_price</label>
                <input type="number" id="retail_priceEdit" name="retail_priceEdit" class="form-control" placeholder="Enter retail_price" />
              </div>
              <div class="col-md-4">
                <label for="org_priceEdit" class="form-label">Original Price</label>
                <input type="number" id="org_priceEdit" name="org_priceEdit" class="form-control" placeholder="Enter original price" />
              </div>
              <!-- <div class="col-md-4">
              ...
              <div class="col-md-4">
                ...
                <input type="text" id="genreEdit" name="genreEdit" class="form-control" placeholder="Enter genre" />
              </div>
              <div class="col-md-4">
                <label for="pagesEdit" class="form-label">Number of Pages</label>
                <input type="number" id="pagesEdit" name="pagesEdit" class="form-control" placeholder="Enter pages" />
              </div>
              <div class="col-md-4">
                <label for="isbnEdit" class="form-label">ISBN</label>
                <input type="number" id="isbnEdit" name="isbnEdit" class="form-control" placeholder="Enter ISBN number" />
              </div>
            </div>
        
            <div class="col mt-4 mb-4">
              <label for="descEdit" class="form-label">Book Description</label>
              <textarea id="descEdit" name="descEdit" class="form-control" placeholder="Enter description" rows="7"></textarea>
            </div>
  ...
  <div class="container">
      ...
      <form action="" method="POST">
        <div class="row g-3">
          <div class="col-md-4">
            ...
            <input type="text" id="image" name="image" class="form-control" placeholder="Upload image" />
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <input type="number" id="retail_price" name="retail_price" class="form-control" placeholder="Enter retail_price" />
          </div>
          <div class="col-md-4">
            <label for="org_price" class="form-label">Original Price</label>
            <input type="number" id="org_price" name="org_price" class="form-control" placeholder="Enter original price" />
          </div>
          <!-- <div class="col-md-4">
            <label for="ratings" class="form-label">Ratings</label>
            <input type="number" id="ratings" class="form-control" placeholder="Enter ratings" />
          ...
          <div class="col-md-4">
            ...
            <input type="number" id="isbn" name="isbn" class="form-control" placeholder="Enter ISBN number" />
          </div>
        </div>
        <div class="col mt-4 mb-4">
              <label for="desc" class="form-label">Book Description</label>
              <textarea id="desc" name="desc" class="form-control" placeholder="Enter description" rows="4"></textarea>
            </div>
    ...
    <?php
        if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_book'])){
            ...
            VALUES 
            (NULL, '$image', '$desc', '1', '$title', '★★★★☆ (4.6/5)', '$retail_price', '$org_price', current_timestamp(), '$genre', '$pages', '$publisher', '$isbn')";
        ...
        while($rows = mysqli_fetch_assoc($result)){
          echo 
              "<tr>
                ...
                <td>
                  <button type='button' class='edit btn btn-sm btn-warning mb-2' id=".$rows['book_id']." data-bs-toggle='modal' data-bs-target='#myModal'><i class='bi bi-pencil-square'></i> Edit</button>
